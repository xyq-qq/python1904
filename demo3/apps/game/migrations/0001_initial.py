# Generated by Django 2.2.1 on 2019-07-16 08:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=20)),
                ('grade', models.IntegerField(default=0)),
                ('phero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Hero')),
            ],
        ),
        migrations.CreateModel(
            name='Warsprit',
            fields=[
                ...
                ('wshero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Hero')),
            ],
        ),
        migrations.CreateModel(
            name='Petdetail',
            fields=[
                ...
                ('pet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Pet')),
            ],
        ),
        migrations.CreateModel(
            name='Othergoods',
            fields=[
                ...
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Goods')),
            ],
        ),
        migrations.AddField(
            model_name='goods',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warsprit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Warsprit')),
            ],
        ),
        migrations.CreateModel(
            name='Arms',
            fields=[
                ...
                ('ahero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.Hero')),
            ],
        ),
    ]
